    ...
    <div className="game">
      <div className="game__front">
        <div className="game-platforms">
          {gamePlatforms.map((platform) => (
            <img key={Math.random()} className="game-platforms__logo" src={platform} />
          ))}
        </div>
        ...
        <div className="rating__wrapper">
          {[...new Array(rating)].map(() => (
            <img key={Math.random()} className="rating" src={star} />
          ))}
        </div>
      </div>
      <div className="game__back">
        <div className="game__back_wrapper">
          ...
          <button className="game__back_wrapper_button">Add to Cart</button>
        </div>
      </div>
    </div>
  </div>
