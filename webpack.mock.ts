...
let games = [
  {
    ...
    gamePrice: 23.99,
    gamePlatformsImg: [GamePlatforms.pc],
    gamePlatforms: ["pc"],
  ...
  },
  {
    ...
    gamePrice: 25.99,
    gamePlatformsImg: [GamePlatforms.pc, GamePlatforms.ps, GamePlatforms.xbox],
  ...
  },
  {
    ...
    gamePrice: 9.99,
    gamePlatformsImg: [GamePlatforms.pc, GamePlatforms.xbox],
  ...
  },
  {
    ...
    gamePrice: 4.99,
    gamePlatformsImg: [GamePlatforms.pc, GamePlatforms.xbox, GamePlatforms.ps],
    gamePlatforms: ["pc", "ps", "xbox"],
    ageLimit: 6,
    rating: 5,
    gameDescription: TEST_DESCRIPTION,
